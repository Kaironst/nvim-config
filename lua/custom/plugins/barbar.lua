return {
  ...
  init = function()
    ...
    map('n', '<leader>a3', '<Cmd>BufferGoto 4<CR>', opts)
    map('n', '<leader>a4', '<Cmd>BufferGoto 5<CR>', opts)
    map('n', '<leader>a5', '<Cmd>BufferGoto 6<CR>', opts)
    map('n', '<leader>a6', '<Cmd>BufferGoto 7<CR>', opts)
    map('n', '<leader>a7', '<Cmd>BufferGoto 8<CR>', opts)
    map('n', '<leader>a8', '<Cmd>BufferGoto 9<CR>', opts)
    map('n', '<leader>a9', '<Cmd>BufferLast<CR>', opts)
